...
namespace Persistence.Migrations
{
    ...
    [Migration("20210708005615_Added Column to MatchdayTeam Table")]
    partial class AddedColumntoMatchdayTeamTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.MatchdayTeam", b =>
                {
                    ...
                    b.HasIndex("MatchdayTeamConfigurationID")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.MatchdayTeam", b =>
                {
                    b.HasOne("Domain.Player", "BenchFour")
                        .WithMany("BenchFourMatchdayTeams")
                        .HasForeignKey("BenchFourID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("Domain.MatchdayTeamConfiguration", "MatchdayTeamConfiguration")
                        ...
                        .HasForeignKey("Domain.MatchdayTeam", "MatchdayTeamConfigurationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Player", b =>
                {
                    b.Navigation("BenchFourMatchdayTeams");
